...
type WerkaArchiveKind = core.WerkaArchiveKind
type WerkaArchivePeriod = core.WerkaArchivePeriod
...
type WerkaCustomerIssueBatchLine = core.WerkaCustomerIssueBatchLine
